...
public class IngredientServiceImpl implements IngredientService {
    ...
    @Override
    public int increasePriceForAllIngredients() {
        return ingredientRepository.increasePriceByTenPercent();
    }

    @Override
    public int increasePriceForChosenItems(List<String> names) {
        return ingredientRepository.increasePriceForChosenItems(names);
    }
}
