...
public class ShampooServiceImpl implements ShampooService {
    ...
    @Override
    public List<Shampoo> findShampoosByIngredients(List<String> ingredients) {
        return shampooRepository.findAllByIngredientsIn(ingredients);
    }

    @Override
    public List<Shampoo> findShampoosWithCountOfIngredientsLessThan(int limit) {
        return shampooRepository.findAllByIngredientsCountLessThan(limit);
    }
}
