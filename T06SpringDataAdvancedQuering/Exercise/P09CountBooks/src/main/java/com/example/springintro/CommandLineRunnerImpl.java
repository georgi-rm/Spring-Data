...
public class CommandLineRunnerImpl implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        System.out.println("Enter minimum length of title:");
        int minimumTitleLength = Integer.parseInt(scanner.nextLine());

        printBooksWithTitleLongerThan(minimumTitleLength);
    }
